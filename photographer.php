...
<body class="sub_page">
    ...
    if (isset($_POST['username'])) {
        ...
        $query    = "SELECT * FROM `preg` WHERE pname='$username' AND ppass='$password' AND pstatus='Accept'";
        ...
        if ($rows == 1) {
            ...
            echo "<div class='form'>
                  ...
                  <p class='link'>Click here to <a href='photographer.php'>Login</a> again.</p>
                  </div>";
        }
    } else {
?>
    <form class="form" method="post" name="login">
        ...
        <p class="link"><a href="photographerreg.php"  class="new-reg">New Registration?</a></p>
  </form>
<?php
    }
?>
